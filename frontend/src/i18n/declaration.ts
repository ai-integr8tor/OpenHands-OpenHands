...
export enum I18nKey {
  ...
  SETTINGS$DATABRICKS_WORKSPACE_HOST = "SETTINGS$DATABRICKS_WORKSPACE_HOST",
  SETTINGS$DATABRICKS_AI_GATEWAY_HOST = "SETTINGS$DATABRICKS_AI_GATEWAY_HOST",
  SETTINGS$DATABRICKS_AI_GATEWAY_HOST_HINT = "SETTINGS$DATABRICKS_AI_GATEWAY_HOST_HINT",
  SETTINGS$DATABRICKS_AI_GATEWAY_HOST_HINT_ADVANCED = "SETTINGS$DATABRICKS_AI_GATEWAY_HOST_HINT_ADVANCED",
  SETTINGS$DATABRICKS_AUTH_METHOD = "SETTINGS$DATABRICKS_AUTH_METHOD",
  SETTINGS$DATABRICKS_AUTH_PAT = "SETTINGS$DATABRICKS_AUTH_PAT",
  SETTINGS$DATABRICKS_AUTH_M2M = "SETTINGS$DATABRICKS_AUTH_M2M",
  SETTINGS$DATABRICKS_AUTH_PROFILE = "SETTINGS$DATABRICKS_AUTH_PROFILE",
  SETTINGS$DATABRICKS_AUTH_U2M = "SETTINGS$DATABRICKS_AUTH_U2M",
  SETTINGS$DATABRICKS_PAT_LABEL = "SETTINGS$DATABRICKS_PAT_LABEL",
  SETTINGS$DATABRICKS_CLIENT_ID = "SETTINGS$DATABRICKS_CLIENT_ID",
  SETTINGS$DATABRICKS_CLIENT_SECRET = "SETTINGS$DATABRICKS_CLIENT_SECRET",
  SETTINGS$DATABRICKS_PROFILE_NAME = "SETTINGS$DATABRICKS_PROFILE_NAME",
  SETTINGS$DATABRICKS_PROFILE_HINT = "SETTINGS$DATABRICKS_PROFILE_HINT",
  SETTINGS$DATABRICKS_ADVANCED_AUTH_HINT = "SETTINGS$DATABRICKS_ADVANCED_AUTH_HINT",
  SETTINGS$DATABRICKS_LLM_SETTINGS_PAGE = "SETTINGS$DATABRICKS_LLM_SETTINGS_PAGE",
  SETTINGS$DATABRICKS_U2M_SETUP_HINT = "SETTINGS$DATABRICKS_U2M_SETUP_HINT",
  SETTINGS$DATABRICKS_U2M_CLIENT_ID = "SETTINGS$DATABRICKS_U2M_CLIENT_ID",
  SETTINGS$DATABRICKS_U2M_CLIENT_ID_HINT = "SETTINGS$DATABRICKS_U2M_CLIENT_ID_HINT",
  SETTINGS$DATABRICKS_U2M_CLIENT_SECRET = "SETTINGS$DATABRICKS_U2M_CLIENT_SECRET",
  SETTINGS$DATABRICKS_U2M_CLIENT_SECRET_HINT = "SETTINGS$DATABRICKS_U2M_CLIENT_SECRET_HINT",
  SETTINGS$DATABRICKS_U2M_REDIRECT_URI = "SETTINGS$DATABRICKS_U2M_REDIRECT_URI",
  SETTINGS$DATABRICKS_U2M_REDIRECT_URI_HINT = "SETTINGS$DATABRICKS_U2M_REDIRECT_URI_HINT",
  SETTINGS$DATABRICKS_SETUP_GUIDE_TITLE = "SETTINGS$DATABRICKS_SETUP_GUIDE_TITLE",
  SETTINGS$DATABRICKS_SETUP_STEP1_LABEL = "SETTINGS$DATABRICKS_SETUP_STEP1_LABEL",
  SETTINGS$DATABRICKS_SETUP_STEP1_INTRO = "SETTINGS$DATABRICKS_SETUP_STEP1_INTRO",
  SETTINGS$DATABRICKS_SETUP_STEP1_FIELD_NAME = "SETTINGS$DATABRICKS_SETUP_STEP1_FIELD_NAME",
  SETTINGS$DATABRICKS_SETUP_STEP1_MATCH = "SETTINGS$DATABRICKS_SETUP_STEP1_MATCH",
  SETTINGS$DATABRICKS_SETUP_STEP1_NEW_APP = "SETTINGS$DATABRICKS_SETUP_STEP1_NEW_APP",
  SETTINGS$DATABRICKS_SETUP_STEP1_COPY_TEXT = "SETTINGS$DATABRICKS_SETUP_STEP1_COPY_TEXT",
  SETTINGS$DATABRICKS_SETUP_STEP1_LOCATION = "SETTINGS$DATABRICKS_SETUP_STEP1_LOCATION",
  SETTINGS$DATABRICKS_SETUP_STEP1_EXISTING = "SETTINGS$DATABRICKS_SETUP_STEP1_EXISTING",
  SETTINGS$DATABRICKS_SETUP_STEP1_EXISTING_ACTION = "SETTINGS$DATABRICKS_SETUP_STEP1_EXISTING_ACTION",
  SETTINGS$DATABRICKS_SETUP_STEP2 = "SETTINGS$DATABRICKS_SETUP_STEP2",
  SETTINGS$DATABRICKS_SETUP_STEP3_LABEL = "SETTINGS$DATABRICKS_SETUP_STEP3_LABEL",
  SETTINGS$DATABRICKS_SETUP_STEP3_SUFFIX = "SETTINGS$DATABRICKS_SETUP_STEP3_SUFFIX",
  SETTINGS$DATABRICKS_SETUP_STEP4_LABEL = "SETTINGS$DATABRICKS_SETUP_STEP4_LABEL",
  SETTINGS$DATABRICKS_SETUP_STEP4_INTRO = "SETTINGS$DATABRICKS_SETUP_STEP4_INTRO",
  SETTINGS$DATABRICKS_SETUP_STEP4_BUTTON = "SETTINGS$DATABRICKS_SETUP_STEP4_BUTTON",
  SETTINGS$DATABRICKS_SETUP_STEP4_SUFFIX = "SETTINGS$DATABRICKS_SETUP_STEP4_SUFFIX",
  SETTINGS$DATABRICKS_SETUP_STEP5_INTRO = "SETTINGS$DATABRICKS_SETUP_STEP5_INTRO",
  SETTINGS$DATABRICKS_SETUP_STEP5_BUTTON = "SETTINGS$DATABRICKS_SETUP_STEP5_BUTTON",
  SETTINGS$DATABRICKS_SETUP_STEP5_SUFFIX = "SETTINGS$DATABRICKS_SETUP_STEP5_SUFFIX",
  SETTINGS$DATABRICKS_SETUP_STEP6_INTRO = "SETTINGS$DATABRICKS_SETUP_STEP6_INTRO",
  SETTINGS$DATABRICKS_SETUP_STEP6_LABEL = "SETTINGS$DATABRICKS_SETUP_STEP6_LABEL",
  SETTINGS$DATABRICKS_SETUP_STEP6_SUFFIX = "SETTINGS$DATABRICKS_SETUP_STEP6_SUFFIX",
  SETTINGS$DATABRICKS_REDIRECT_URI_REGISTER_LABEL = "SETTINGS$DATABRICKS_REDIRECT_URI_REGISTER_LABEL",
  SETTINGS$DATABRICKS_REDIRECT_URI_COPY = "SETTINGS$DATABRICKS_REDIRECT_URI_COPY",
  SETTINGS$DATABRICKS_REDIRECT_URI_USE_THIS = "SETTINGS$DATABRICKS_REDIRECT_URI_USE_THIS",
  SETTINGS$DATABRICKS_REFRESH_MODELS_HINT = "SETTINGS$DATABRICKS_REFRESH_MODELS_HINT",
  SETTINGS$DATABRICKS_MODELS_NEW_PROFILE_HINT = "SETTINGS$DATABRICKS_MODELS_NEW_PROFILE_HINT",
  SETTINGS$DATABRICKS_MODELS_DISCOVERY_FAILED_HINT = "SETTINGS$DATABRICKS_MODELS_DISCOVERY_FAILED_HINT",
}
